...
The `milkyway-test-env` project is a container-based test environment (Docker) used to host the Andromeda application, a
file server, and a full monitoring stack (Prometheus, Grafana, Loki). The entire setup is secured and managed by the
