...
-- users and passwords
CREATE
USER IF NOT EXISTS `wolf`@`%`      IDENTIFIED BY 'CHANGE_ME';
CREATE
USER IF NOT EXISTS `andromeda`@`%` IDENTIFIED BY 'CHANGE_ME';
CREATE
USER IF NOT EXISTS `nebula`@`%`    IDENTIFIED BY 'CHANGE_ME';
CREATE
USER IF NOT EXISTS `chess`@`%`     IDENTIFIED BY 'CHANGE_ME';
CREATE
USER IF NOT EXISTS `robak`@`%`     IDENTIFIED BY 'CHANGE_ME';
CREATE
USER IF NOT EXISTS `racer`@`%`     IDENTIFIED BY 'CHANGE_ME';
CREATE
USER IF NOT EXISTS `element`@`%`   IDENTIFIED BY 'CHANGE_ME';
